...
⭐ [Star the repo](https://github.com/philiprehberger/rs-assert-cmd)

🐛 [Report issues](https://github.com/philiprehberger/rs-assert-cmd/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/rs-assert-cmd/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
